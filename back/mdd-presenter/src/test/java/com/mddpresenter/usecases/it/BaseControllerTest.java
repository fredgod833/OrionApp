...
public abstract class BaseControllerTest {
    ...
    protected RequestBuilder asyncDeleteRequest(String url, String token, String jwtRefresh) throws Exception {
        return methodRequestBuilderWithCookies(token, jwtRefresh, delete(url));
    }
